 ...
 * @author toshıba pc
 */
public class İnvolinDia_view extends JDialog{
 private JTextField itemNameField;
    ...
    public İnvolinDia_view(İnvoGen_Frame_Run frame) {
     ...
     public İnvolinDia_view(com.invoGen.View.invoGen_Frame invoiceFrame) {
