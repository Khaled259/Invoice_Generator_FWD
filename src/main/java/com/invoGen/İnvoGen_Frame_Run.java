...
import com.invoGen.Controler.nlistener;
 ...
 * @author toshıba pc
 */
public class İnvoGen_Frame_Run extends javax.swing.JFrame   {

    /**
     * Creates new form InvoiceFrame
     */
    public İnvoGen_Frame_Run() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(İnvoGen_Frame_Run.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new İnvoGen_Frame_Run().setVisible(true);
            }
        });
    }
  ;
...
private nlistener listener = new nlistener(this);
...
private DateFormat df = new SimpleDateFormat("dd-MM-yyyy");
    ...
    public void setInvHeaderTableModel(invoHeadTab_model invHeaderTableModel) {
    ...
    public invoHeadTab_model getInvHeaderTableModel() {
        return invHeaderTableModel;
    }

    public invoLinTab_model getInvLineTableModel() {
        return invLineTableModel;
    }

    public İnvoHeadDia_view getHeaderDialog() {
        return headerDialog;
    }

    public İnvolinDia_view getLineDialog() {
        return lineDialog;
    }

    public void setInvLineTableModel(invoLinTab_model invLineTableModel) {
        this.invLineTableModel = invLineTableModel;
    }

    public void setHeaderDialog(İnvoHeadDia_view headerDialog) {
        this.headerDialog = headerDialog;
    }

    public void setLineDialog(İnvolinDia_view lineDialog) {
